...
import { LocalTimelineRepository, PublicTimelineRepository, SandboxTimelineRepository, SupabaseTimelineRepository } from "./repositories.js";
...
async function startSandbox() {
  repository = hasSupabaseConfig() ? new SandboxTimelineRepository() : new LocalTimelineRepository();
  state.mode = "sandbox";
  state.user = null;
